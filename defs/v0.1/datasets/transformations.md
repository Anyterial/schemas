...
**ID: [`https://schemas.anyterial.se/defs/v0.1/datasets/transformations`](https://schemas.anyterial.se/defs/v0.1/datasets/transformations.md)**  
**Definition name:** `transformations`

**Property name:** Transformations  
**Description:** Ordered table of crystallographic transformation records.
...
- Items MUST be ordinary dictionaries rather than being keyed by H-M entry.
- The `hm_entry` property identifies the International Tables H-M entry represented by the item.
- The `hall_entry` property identifies the Hall setting used to generate setting-specific normalizer and transformation data.

**Examples:**

- `[{"hm_entry": "P 1", "hall_entry": "p_1", "centering_translations": [["0", "0", "0"]], "centering_translations_xyz": ["0,0,0"], "baernighausen": []}]`

**Formats:** [[JSON](transformations.json)] [[MD](transformations.md)]

**JSON definition:**

``` json
{
    "$id": "https://schemas.anyterial.se/defs/v0.1/datasets/transformations",
    "$schema": "https://schemas.optimade.org/meta/v1.3/optimade/property_definition.json",
    "title": "Transformations",
    "$comment": "Dataset of transformation entries.",
