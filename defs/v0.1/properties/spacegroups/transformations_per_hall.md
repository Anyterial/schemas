# Transformations per Hall entry (property)

This page documents an [OPTIMADE](https://www.optimade.org/) [Property Definition](https://schemas.optimade.org/#definitions). See [https://schemas.optimade.org/](https://schemas.optimade.org/) for more information.

**ID: [`https://schemas.anyterial.se/defs/v0.1/properties/spacegroups/transformations_per_hall`](https://schemas.anyterial.se/defs/v0.1/properties/spacegroups/transformations_per_hall.md)**  
**Definition name:** `transformations_per_hall`

**Property name:** Transformations per Hall entry  
...
- `[{"hall_entry": "p_1", "baernighausen": []}]`

**Formats:** [[JSON](transformations_per_hall.json)] [[MD](transformations_per_hall.md)]
