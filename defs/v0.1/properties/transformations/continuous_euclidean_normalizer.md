...
**ID: [`https://schemas.anyterial.se/defs/v0.1/properties/transformations/continuous_euclidean_normalizer`](https://schemas.anyterial.se/defs/v0.1/properties/transformations/continuous_euclidean_normalizer.md)**  
...
``` json
{
    ...
    "x-optimade-definition": {
        ...
        "label": "continuous_euclidean_normalizer_transformations"
    },
