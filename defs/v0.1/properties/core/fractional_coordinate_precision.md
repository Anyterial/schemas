...
**ID: [`https://schemas.anyterial.se/defs/v0.1/properties/core/fractional_coordinate_precision`](https://schemas.anyterial.se/defs/v0.1/properties/core/fractional_coordinate_precision.md)**  
...
- The value is **dimensionless**, being a fraction of a cell edge. Multiplying by a cell
  ...
  [`length_precision`](https://schemas.anyterial.se/defs/v0.1/properties/core/length_precision).
...
**Formats:** [[JSON](fractional_coordinate_precision.json)] [[MD](fractional_coordinate_precision.md)]

**JSON definition:**

``` json
{
    "$id": "https://schemas.anyterial.se/defs/v0.1/properties/core/fractional_coordinate_precision",
