# IT number to std spacegroups index (property)

This page documents an [OPTIMADE](https://www.optimade.org/) [Property Definition](https://schemas.optimade.org/#definitions). See [https://schemas.optimade.org/](https://schemas.optimade.org/) for more information.

**ID: [`https://schemas.anyterial.se/defs/v0.1/properties/spacegroups/index_it_number_to_std_spacegroups`](https://schemas.anyterial.se/defs/v0.1/properties/spacegroups/index_it_number_to_std_spacegroups.md)**  
**Definition name:** `index_it_number_to_std_spacegroups`

**Property name:** IT number to std spacegroups index  
...
**Formats:** [[JSON](index_it_number_to_std_spacegroups.json)] [[MD](index_it_number_to_std_spacegroups.md)]
