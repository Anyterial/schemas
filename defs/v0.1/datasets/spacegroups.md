...
**ID: [`https://schemas.anyterial.se/defs/v0.1/datasets/spacegroups`](https://schemas.anyterial.se/defs/v0.1/datasets/spacegroups.md)**  
...
``` json
{
    "$id": "https://schemas.anyterial.se/defs/v0.1/datasets/spacegroups",
