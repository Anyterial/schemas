# Hall alias markups (property)

This page documents an [OPTIMADE](https://www.optimade.org/) [Property Definition](https://schemas.optimade.org/#definitions). See [https://schemas.optimade.org/](https://schemas.optimade.org/) for more information.

**ID: [`https://schemas.anyterial.se/defs/v0.1/properties/spacegroups/hall_aliases_markup`](https://schemas.anyterial.se/defs/v0.1/properties/spacegroups/hall_aliases_markup.md)**  
**Definition name:** `hall_aliases_markup`

**Property name:** Hall alias markups  
...
**Formats:** [[JSON](hall_aliases_markup.json)] [[MD](hall_aliases_markup.md)]
