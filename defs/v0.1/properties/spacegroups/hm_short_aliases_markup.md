# Short Hermann-Mauguin alias markups (property)

This page documents an [OPTIMADE](https://www.optimade.org/) [Property Definition](https://schemas.optimade.org/#definitions). See [https://schemas.optimade.org/](https://schemas.optimade.org/) for more information.

**ID: [`https://schemas.anyterial.se/defs/v0.1/properties/spacegroups/hm_short_aliases_markup`](https://schemas.anyterial.se/defs/v0.1/properties/spacegroups/hm_short_aliases_markup.md)**  
**Definition name:** `hm_short_aliases_markup`

**Property name:** Short Hermann-Mauguin alias markups  
...
- `[{"html": "<i>P</i> 1", "latex": "\\mathrm{P} 1", "unicode": "P 1"}]`

**Formats:** [[JSON](hm_short_aliases_markup.json)] [[MD](hm_short_aliases_markup.md)]
