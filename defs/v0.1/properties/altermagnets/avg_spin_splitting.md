# Average spin splitting (property)

This page documents an [OPTIMADE](https://www.optimade.org/) [Property Definition](https://schemas.optimade.org/#definitions). See [https://schemas.optimade.org/](https://schemas.optimade.org/) for more information.

**ID: [`https://schemas.anyterial.se/defs/v0.1/properties/altermagnets/avg_spin_splitting`](https://schemas.anyterial.se/defs/v0.1/properties/altermagnets/avg_spin_splitting.md)**  
...
**Formats:** [[JSON](avg_spin_splitting.json)] [[MD](avg_spin_splitting.md)]
