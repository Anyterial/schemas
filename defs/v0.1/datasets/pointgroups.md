...
**ID: [`https://schemas.anyterial.se/defs/v0.1/datasets/pointgroups`](https://schemas.anyterial.se/defs/v0.1/datasets/pointgroups.md)**  
...
``` json
{
    "$id": "https://schemas.anyterial.se/defs/v0.1/datasets/pointgroups",
